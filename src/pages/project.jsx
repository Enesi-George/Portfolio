...
export default function Project() {
  return (
    <Box
      className="fade-in-y"
      sx={{
        margin: '100px 24px', // Adjust margin for smaller devices
        color: 'black',
      }}
    >
      <Divider color="black" variant component="h2" xs={12}>
        Projects
      </Divider>
      <List
        sx={{
        ...
        <Grid item xs={12} sx={{ margin: '20px 0px' }}>
          ...
          <ListItem sx={{ pl: 7, mt: -2 }}>
            ...
            <Link
              className="link"
              target="_blank"
              href="https://64ad433dec9502008918aa31--friendly-genie-09a8d8.netlify.app/"
            >
              Landing page of an Airbnb
            </Link>
          </ListItem>
          <Divider>
            <SchoolOutlinedIcon
